            ...
            <div class="col-lg-12">
                <div class="home-wrapper">
                    <h2 class="animated fadeInDown wow" data-wow-delay=".1s">
                        <span class="text-colored"><g:message code="website.register.fail.title"></g:message></span>
                    </h2>
                    <p class="animated fadeInDown wow text-muted" data-wow-delay=".2s">
                        <g:message code="website.register.fail.message"></g:message>
                    </p>
...
<!-- FOOTER -->
%{--style="padding-top: 100px;padding-bottom: 170px"--}%
<footer class="bg-gray footer footer-sm" >
    <div class="container">
